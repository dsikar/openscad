...
// v1.4 increased groove width by 0.5mm and groove depth by 1mm
//        included small threaded ring
...
module inner_threaded_ring() {
	import("C:\\Users\\Intel\\Documents\\OpenSCAD\\FunnelTip\\FunnelTip1.4SmallRingThreaded.stl");	
}
...
/*
		difference() {
			...
			union() {
				...
				(h = 4.3, r=2.75, center = true, $fn = 100);
				translate([0, 0, 10.4])	  
				cube([5.5, 4.3, 20.8], center = true, $fn = 100);
			}
			...
			union() {
				translate([0, 0, 20.8])	  
				rotate ([90,0,120]) cylinder (h = 4.3, r=2.75, center = true, $fn = 100);
			...
			union() {
				...
				cube([5.5, 4.3, 19.602], center = true, $fn = 100);
			}
			...
			union() {
				translate([0, 0, 20.8])	  
				rotate ([90,0,60]) cylinder (h = 4.3, r=2.75, center = true, $fn = 100);
